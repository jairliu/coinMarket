...
public class PerformanceWatcherForm {
    ...
    public boolean isModified() {
        ...
        try {
            modified = attemps != Integer.parseInt(attempsField.getText()) || unresponsiveInterval != Integer.parseInt(unresponsiveIntervalField.getText());
    ...
    public void apply() {
        ...
        if (attemps < 0 || unresponsiveInterval < 0) {
